...
import com.lukflug.module.ClickGUIModule.Theme;
import com.lukflug.module.HUDEditorModule;
//import com.lukflug.module.LogoModule;
//import com.lukflug.module.TabGUIModule;
//import com.lukflug.module.WatermarkModule;
...
public class ClickGUI extends MinecraftHUDGUI {
    ...
    public ClickGUI() {
        ...
        /* Set too false to disable horizontal clipping, this may cause graphical glitches,
...
//        gui.addHUDComponent(WatermarkModule.getComponent(),WatermarkModule.getToggle(),animation.get(),theme,BORDER);
        ...
        ILayout categoryCSGOLayout=new CSGOLayout(new Labeled("GG Client",null,()->true),new Point(100,100),480,WIDTH,animation,"Enabled",false,false,2,ChildMode.POPUP,colorPopup) {
            @Override
            public int getScrollHeight (Context context, int componentHeight) {
        ...
        ILayout searchableCSGOLayout=new SearchableLayout(new Labeled("GG Client",null,()->true),new Labeled("Search",null,()->true),new Point(100,100),480,WIDTH,animation,"Enabled",2,ChildMode.POPUP,colorPopup,(a,b)->a.getDisplayName().compareTo(b.getDisplayName()),charFilter,keys) {
            @Override
            public int getScrollHeight (Context context, int componentHeight) {
